...
function loadWidget(config) {
	...
	let userAction = false,
		userActionTimer,
		messageTimer,
		messageArray = ["Long time no see, life flies so fast...", "Big bad guy! How long have you been ignoring people, huh huh~", "Hi~ come and play with me!", "Take a punch Hammer your chest!", "Remember to add Xiaojia to the Adblock whitelist!"];
	...
	(function welcomeMessage() {
		...
		if (location.pathname === "/") { // 如果是主页
			...
			else text = "Are you a night owl? If you haven't gone to bed so late, will you get up tomorrow?";
